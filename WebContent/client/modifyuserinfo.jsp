							...
							<td>
								<table width="100%" border="0" cellspacing="2" class="upline">
									...
									<tr>
										...
										<td><input type="text" class="textinput" name="id" value="${user.id}" readonly="readonly"/></td>
										<td>&nbsp;</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td colspan="2">
											<input  type="text" value="${user.telephone}" class="textinput" name="telephone"/>
										</td>
									</tr>
									<tr>
								...
								<p style="text-align:center">
									<input src="${pageContext.request.contextPath }/client/images/botton_gif_025.gif" type="image" alt="submit">			
								</p>
